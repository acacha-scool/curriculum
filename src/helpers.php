...
if (! function_exists('seed_submodules_grouped_by_module()')) {
    ...
    function seed_submodules_grouped_by_module()
    {
        ...
        first_or_create_submodule("GAD_MP07_UF1","UF1","Tecnologia i comunicacions digitals","","active",1,"Normal",obtainModuleIdByCode("GAD_MP07"), [obtainClassroomIdByCode("1GAD"), obtainClassroomIdByCode("1GAD")]);
        first_or_create_submodule("GAD_MP07_UF2","UF2","Ordinagrafia i gravació de dades","","active",2,"Normal",obtainModuleIdByCode("GAD_MP07"), [obtainClassroomIdByCode("1GAD"), obtainClassroomIdByCode("1GAD")]);
        first_or_create_submodule("GAD_MP07_UF3","UF3","Tractament de la informació escrita i numèrica","","active",3,"Normal",obtainModuleIdByCode("GAD_MP07"), [obtainClassroomIdByCode("1GAD"), obtainClassroomIdByCode("1GAD")]);
        first_or_create_submodule("GAD_MP07_UF4","UF4","Tractament de dades i integració d'aplicacions","","active",4,"Normal",obtainModuleIdByCode("GAD_MP07"), [obtainClassroomIdByCode("1GAD"), obtainClassroomIdByCode("1GAD")]);
        first_or_create_submodule("GAD_MP07_UF5","UF5","Presentacions multimèdia de continguts","","active",5,"Normal",obtainModuleIdByCode("GAD_MP07"), [obtainClassroomIdByCode("1GAD"), obtainClassroomIdByCode("1GAD")]);
        first_or_create_submodule("GAD_MP07_UF6","UF6","Eines d'internet per a l'empresa","","active",6,"Normal",obtainModuleIdByCode("GAD_MP07"), [obtainClassroomIdByCode("1GAD"), obtainClassroomIdByCode("1GAD")]);
        ...
        first_or_create_submodule("GAD_MP12_UF1","UF1","Incorporació al treball","","active",1,"Externes",obtainModuleIdByCode("GAD_MP12"), [obtainClassroomIdByCode("1GAD"), obtainClassroomIdByCode("1GAD")]);
        first_or_create_submodule("GAD_MP12_UF2","UF2","Prevenció de riscos laborals","","active",2,"Externes",obtainModuleIdByCode("GAD_MP12"), [obtainClassroomIdByCode("1GAD"), obtainClassroomIdByCode("1GAD")]);
