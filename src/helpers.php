...
if (! function_exists('seed_submodules_grouped_by_module()')) {
    ...
    function seed_submodules_grouped_by_module()
    {
        ...
        first_or_create_submodule("ACO_MP01_UF1","UF1","Organització de l'espai comercial i gestió de l'àrea expositiva","","active",1,"Normal",obtainModuleIdByCode("ACO_MP01"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP01_UF2","UF2","Aparadorisme: Muntatge i manteniment","","active",2,"Normal",obtainModuleIdByCode("ACO_MP01"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP01_UF3","UF3","Accions promocionals en el punt de venda","","active",3,"Normal",obtainModuleIdByCode("ACO_MP01"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        ...
        first_or_create_submodule("ACO_MP03_UF1","UF1","Emprenedoria i creació d'un petit comerç","","active",1,"Normal",obtainModuleIdByCode("ACO_MP03"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP03_UF2","UF2","Gestió econòmica d'un petit comerç","","active",2,"Normal",obtainModuleIdByCode("ACO_MP03"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP03_UF3","UF3","Procés administratiu, comptable i fiscal","","active",3,"Normal",obtainModuleIdByCode("ACO_MP03"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_module("ACO_MP04","MP04","Processos de venda","","active",4,"Normal");
        first_or_create_submodule("ACO_MP04_UF1","UF1","Venda al consumidor final","","active",1,"Normal",obtainModuleIdByCode("ACO_MP04"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP04_UF2","UF2","Venda a intermediaris, empreses i organitzacions","","active",2,"Normal",obtainModuleIdByCode("ACO_MP04"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP04_UF3","UF3","Terminal punt de venda (TPV) i altres eines de gestió de venda","","active",3,"Normal",obtainModuleIdByCode("ACO_MP04"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        ...
        first_or_create_submodule("ACO_MP06_UF1","UF1","Organització i seguretat del magatzem","","active",1,"Normal",obtainModuleIdByCode("ACO_MP06"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP06_UF2","UF2","Recepció de mercaderies","","active",2,"Normal",obtainModuleIdByCode("ACO_MP06"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP06_UF3","UF3","Expedició de mercaderies","","active",3,"Normal",obtainModuleIdByCode("ACO_MP06"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP06_UF4","UF4","Inventari i gestió d'estocs","","active",4,"Normal",obtainModuleIdByCode("ACO_MP06"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        ...
        first_or_create_submodule("ACO_MP09_UF1","UF1","Tecnologies digitals i eines d'internet per l'empresa","","active",1,"Normal",obtainModuleIdByCode("ACO_MP09"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP09_UF2","UF2","Edició digital de material publicitari","","active",2,"Normal",obtainModuleIdByCode("ACO_MP09"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP09_UF3","UF3","Gestió de bases de dades i fulls de càcul","","active",3,"Normal",obtainModuleIdByCode("ACO_MP09"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        ...
        first_or_create_submodule("ACO_MP11_UF1","UF1","Màrqueting i investigació de mercats","","active",1,"Normal",obtainModuleIdByCode("ACO_MP11"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP11_UF1","UF1","Recerca d'informació i pla de màqueting","","active",1,"Normal",obtainModuleIdByCode("ACO_MP11"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP11_UF2","UF2","Polítiques comercials i pla de màrqueting","","active",2,"Normal",obtainModuleIdByCode("ACO_MP11"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP11_UF2","UF2","Producte i distribució","","active",2,"Normal",obtainModuleIdByCode("ACO_MP11"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        first_or_create_submodule("ACO_MP11_UF3","UF3","Preu i comunicació","","active",3,"Normal",obtainModuleIdByCode("ACO_MP11"), [obtainClassroomIdByCode("1ACO"), obtainClassroomIdByCode("1ACO A"), obtainClassroomIdByCode("1ACO B")]);
        ...
        first_or_create_submodule("APD_MP01_UF1","UF1","Context de la intervenció sociosanitària","","active",1,"Normal",obtainModuleIdByCode("APD_MP01"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP01_UF2","UF2","Organització de la intervenció sociosanitària","","active",2,"Normal",obtainModuleIdByCode("APD_MP01"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_module("APD_MP02","MP02","Atenció sanitària","","active",2,"Normal");
        first_or_create_submodule("APD_MP02_UF1","UF1","Mobilització de persones en situació de dependència","","active",1,"Normal",obtainModuleIdByCode("APD_MP02"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP02_UF2","UF2","Activitats d'assistència sanitària","","active",2,"Normal",obtainModuleIdByCode("APD_MP02"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP02_UF3","UF3","Suport en la ingesta","","active",3,"Normal",obtainModuleIdByCode("APD_MP02"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP02_UF4","UF4","Aplicació de tractaments per a persones en situació de dependència","","active",4,"Normal",obtainModuleIdByCode("APD_MP02"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_module("APD_MP03","MP03","Atenció higiènica","","active",3,"Normal");
        first_or_create_submodule("APD_MP03_UF1","UF1","Higiene personal","","active",1,"Normal",obtainModuleIdByCode("APD_MP03"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP03_UF2","UF2","Higiene de l'entorn","","active",2,"Normal",obtainModuleIdByCode("APD_MP03"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_module("APD_MP04","MP04","Atenció i suport psicosocial","","active",4,"Normal");
        first_or_create_submodule("APD_MP04_UF1","UF1","Suport en el desenvolupament dels hàbits d'autonomia personal i social","","active",1,"Normal",obtainModuleIdByCode("APD_MP04"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP04_UF2","UF2","Suport en l'estimulació cognitiva de les persones","","active",2,"Normal",obtainModuleIdByCode("APD_MP04"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP04_UF3","UF3","Suport en l'animació grupal","","active",3,"Normal",obtainModuleIdByCode("APD_MP04"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP04_UF4","UF4","Suport en el desenvolupament de les relacions socials","","active",4,"Normal",obtainModuleIdByCode("APD_MP04"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        ...
        first_or_create_submodule("APD_MP05_UF1","UF1","Autonomia personal","","active",1,"Normal",obtainModuleIdByCode("APD_MP05"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP05_UF2","UF2","Persones grans","","active",2,"Normal",obtainModuleIdByCode("APD_MP05"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP05_UF3","UF3","Persones amb malaltia mental","","active",3,"Normal",obtainModuleIdByCode("APD_MP05"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP05_UF4","UF4","Persones amb discapacitat intel·lectual","","active",4,"Normal",obtainModuleIdByCode("APD_MP05"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP05_UF5","UF5","Persones amb discapacitat física","","active",5,"Normal",obtainModuleIdByCode("APD_MP05"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        ...
        first_or_create_submodule("APD_MP11_UF1","UF1","Incorporació al treball","","active",1,"Externes",obtainModuleIdByCode("APD_MP11"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
        first_or_create_submodule("APD_MP11_UF2","UF2","Prevenció de riscos laborals","","active",2,"Externes",obtainModuleIdByCode("APD_MP11"), [obtainClassroomIdByCode("1APD A"), obtainClassroomIdByCode("1APD B"), ]);
